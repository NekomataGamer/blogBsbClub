<div class="page-header">
    <h4 class="page-title">Inserir Cliente</h4>
    <ol class="breadcrumb">
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <div class="card-title">Inserir Cliente</div>
            </div>
            <div class="card-body">
                ...
                <form method="POST" enctype="multipart/form-data">
                    <div class="form-group ">
                        ...
                        <input type="text" class="form-control w-100"  placeholder="" name="nome">
                    </div>

                    <div class="form-group ">
                        <label class="form-label">CPF</label>
                        <input type="text" class="form-control w-100 cpf"  placeholder="" name="cpf" onblur="validarCPF(this.value)">
                    </div>
                    
                    <div class="form-group ">
                        <label class="form-label">RG</label>
                        <input type="text" class="form-control w-100"  placeholder="" name="rg">
                    </div>

                    <div class="form-group ">
                        <label class="form-label">Nome da Mãe</label>
                        <input type="text" class="form-control w-100"  placeholder="" name="nome_mae">
                    </div>
                    ...
                    <div class="form-group ">
                        ...
                        <input type="text" class="form-control w-100"  placeholder="" name="complemento" id="">
                    </div>
