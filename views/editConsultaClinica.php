                    ...
                    <div class="row">
                        <div class="col-md-5">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control"  placeholder="Consulta" name="proc" value="<?php echo (isset($dataConsulta['procedimento']))?$dataConsulta['procedimento']:'';?>">
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control price" placeholder="R$" name="val_coust" value="<?php echo (isset($dataConsulta['val_coust']))?$dataConsulta['val_coust']:'';?>">
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control price" placeholder="R$" name="val_sell" value="<?php echo (isset($dataConsulta['val_sell']))?$dataConsulta['val_sell']:'';?>">
                            </div>
                        </div>
                    </div>
                </div>
