		...
		<section class="sptb bg-white" id="cat">
				...
				<div class="row">
						...
						<div class="card bg-card-light">
							<div class="card-body">
								<div class="cat-item text-center">
									...
									<div class="cat-img">
										<img src="../../assets//images/products/categories/excercise.png" alt="img">
									</div>
									<div class="cat-desc">
										<h5 class="mb-1">Academias</h5>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="card bg-card-light">
							<div class="card-body">
								<div class="cat-item text-center">
									<a href="classifieds-list.html"></a>
									<div class="cat-img">
										<img src="../../assets//images/products/categories/eco-car.png" alt="img">
									</div>
									<div class="cat-desc">
										<h5 class="mb-1">Veículos</h5>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="card bg-card-light">
							<div class="card-body">
								<div class="cat-item text-center">
									<a href="classifieds-list.html"></a>
									<div class="cat-img">
										<img src="../../assets//images/products/categories/company.png" alt="img">
									</div>
									<div class="cat-desc">
										<h5 class="mb-1">Escritórios</h5>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="card-body">
								<div class="cat-item text-center">
									...
									<div class="cat-img text-shadow1">
										<img src="../../assets//images/products/categories/traveler.png" alt="img">
									</div>
									<div class="cat-desc">
										<h5 class="mb-1">Turismo</h5>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="col-xl-2 col-lg-2 col-md-3 col-sm-6">
						<div class="card bg-card-light">
							<div class="card-body">
								<div class="cat-item text-center">
									<a href=http://bsbclub.com.br/educacao.html#></a>
									<div class="cat-img">
										<img src="../../assets//images/products/categories/—Pngtree—graduation hat and book_3559769.png" alt="img" height="200px" width="1000">
									</div>
									<div class="cat-desc">
										<h5 class="mb-1">Educação</h5>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="card bg-card-light">
							<div class="card-body">
								<div class="cat-item text-center">
									<a href="classifieds-list.html"></a>
									<div class="cat-img">
										<img src="../../assets//images/products/categories/home.png" alt="img">
									</div>
									<div class="cat-desc">
										<h5 class="mb-1">Imóveis</h5>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="card bg-card-light">
							<div class="card-body">
								<div class="cat-item text-center">
									<a href="classifieds-list.html"></a>
									<div class="cat-img">
										<img src="../../assets//images/products/categories/sarafan.png" alt="img">
									</div>
									<div class="cat-desc">
										<h5 class="mb-1">Moda </h5>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="card bg-card-light">
							<div class="card-body">
								<div class="cat-item text-center">
									<a href="classifieds-list.html"></a>
									<div class="cat-img">
										<img src="../../assets//images/products/categories/living-room.png" alt="img">
									</div>
									<div class="cat-desc">
										<h5 class="mb-1">Decoração</h5>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="card bg-card-light">
							<div class="card-body">
								<div class="cat-item text-center">
									<a href="classifieds-list.html"></a>
									<div class="cat-img">
										<img src="../../assets/images/products/categories/tv.png" alt="img">
									</div>
									<div class="cat-desc">
										<h5 class="mb-1">Eletrônicos</h5>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="card bg-card-light">
							<div class="card-body">
								<div class="cat-item text-center">
									<a href="classifieds-list.html"></a>
									<div class="cat-img">
										<img src="../../assets/images/products/categories/musical-notes.png" alt="img">
									</div>
									<div class="cat-desc">
										<h5 class="mb-1">Música e Hobbie</h5>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="card bg-card-light">
							<div class="card-body">
								<div class="cat-item text-center">
									<a href="classifieds-list.html"></a>
									<div class="cat-img">
										<img src="../../assets/images/products/categories/sports-ball-png-2-transparent.png" alt="img">
									</div>
									<div class="cat-desc">
										<h5 class="mb-1">Esportes e Lazer</h5>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="card bg-card-light">
							<div class="card-body">
								<div class="cat-item text-center">
									<a href="classifieds-list.html"></a>
									<div class="cat-img">
										<img src="../../assets/images/products/categories/NicePng_placeholder-png_7998911.png" alt="img">
									</div>
									<div class="cat-desc">
										<h5 class="mb-1">Saúde</h5>
									</div>
								</div>
							</div>
						</div>
          ...
          <div class="col-xl-2 col-lg-2 col-md-3 col-sm-6">
						<div class="card bg-card-light">
							<div class="card-body">
								<div class="cat-item text-center">
									<a href="http://bsbclub.com.br/beleza.html#"></a>
									<div class="cat-img">
										<img src="../../assets//images/products/categories/beleza.png" alt="img">
									</div>
									<div class="cat-desc">
										<h5 class="mb-1">Beleza</h5>
									</div>
								</div>
							</div>
						</div>
