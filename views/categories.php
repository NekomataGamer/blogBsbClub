    ...
    <div class="container">
        <div class="row">
            <div class="col-xl-9 col-lg-8 col-md-12">
                ...
                <div class="ribbon ribbon-top-left text-danger"><span class="bg-danger">Desconto 15%</span></div>
                                        <div class="d-md-flex">
                                            <div class="item-card9-img">
                                                
                                                <div class="item-card9-imgs">
                                                    <a href="#"></a>
                                                    <img src="../../assets//images/brand/BELLA ELLA - LOGO PRIMARIA NEGATIVA.png" alt="img" class="cover-image">
                                                </div>
                            ...
                            <div class="arrow-ribbon bg-primary">Beleza</div>
                        <br>
                                                        
                                                        <a href="#                         
                                    " class="text-dark"><h4 class="font-weight-semibold mt-1">Bella Ella </h4></a>
                        <br>
...
<!-- 											<div class="card overflow-hidden">
                                        <div class="ribbon ribbon-top-left text-danger"><span class="bg-danger">Desconto 10%</span></div>
                                        <div class="d-md-flex">
                                            <div class="item-card9-img">
                                                <div class="item-card9-imgs">
                                                    <a href="http://bsbclub.com.br/sistema/acuuniversity.html"></a>
                                                    <img src="../../assets//images/brand/acu.png" alt="img" class="cover-image">
                                                </div>
                                                <div class="item-card9-icons">
                                                    <a href="http://bsbclub.com.br/sistema/acuuniversity.html" class="item-card9-icons1 wishlist active"> <i class="fa fa fa-heart-o"></i></a>
                                                </div>
                                            </div>
                                            <div class="card mb-0 border-0">
                                                <div class="card-body ">
                                                    <div class="item-card9">
                                                        <div class="arrow-ribbon bg-primary">Educação</div>
                        <br>
                                                        <a href="http://bsbclub.com.br/sistema/acuuniversity.html" class="text-dark"><h4 class="font-weight-semibold mt-1">Acu - Absoulute Christian University </h4></a>
                        <br>
                                                        <p class="mb-0 leading-tight">Faça seu mestrado e doutorado 100% ONLINE</p>
                                                    </div>
                                                </div>
                                                <div class="card-footer pt-4 pb-4">
                                                    <div class="item-card9-footer d-flex">
...
<!-- 											<div class="card overflow-hidden">
                                        <div class="ribbon ribbon-top-left text-danger"><span class="bg-danger">10% Desconto</span></div>
                                        <div class="d-md-flex">
                                            <div class="item-card9-img">
                                                <div class="item-card9-imgs">
                                                    <a href="classified.html"></a>
                                                    <img src="../../assets//images/brand/curso.png" alt="img" class="cover-image">
                                                </div>
                                                <div class="item-card9-icons">
                                                    <a href="#" class="item-card9-icons1 wishlist"> <i class="fa fa fa-heart-o"></i></a>
                                                </div>
                        ...
                        <br>
                                                        <div class="arrow-ribbon bg-primary">Educação</div>
                                                        <a href="classified.html" class="text-dark"><h4 class="font-weight-semibold mt-1">Absoulute On</h4></a>
                        <br>
                                                        <p class="mb-0 leading-tight">Especializada em Cursos Profissionalizantes</p>
                                                    </div>
                                                </div>
                                                <div class="card-footer pt-4 pb-4">
                                                    <div class="item-card9-footer d-flex">
                                        ...
                                        <div class="d-md-flex">
                                            <div class="item-card9-img">
                                                ...
                                                <div class="ribbon ribbon-top-left text-danger"><span class="bg-danger">10% Desconto</span></div>
                                                    ...
                                                    <img src="../../assets//images/brand/x educacional.png" alt="img" class="cover-image">
                                                </div>
                                                <div class="item-card9-icons">
                                                    <a href="http://bsbclub.com.br/sistema/xeducacional.html#" class="item-card9-icons1 wishlist active"> <i class="fa fa fa-heart-o"></i></a>
                                                </div>
                                            </div>
                                            <div class="card border-0 mb-0">
                                                <div class="card-body ">
                                                    <div class="item-card2">
                                                        <div class="item-card2-desc">
                                                            <div class="arrow-ribbon bg-primary">Educação</div>
                            <br>
                                                            <a href="http://bsbclub.com.br/sistema/xeducacional.html#" class="text-dark mt-2"><h4 class="font-weight-semibold mt-1">X Educacional</h4></a>
                            <br>
                                                            <p class="mb-0 leading-tight">Uma Empresa de consultoria e acessoria educacional.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="ml-auto">
...
<!-- 											<div class="card overflow-hidden">
                                        <div class="d-md-flex">
                                            <div class="item-card9-img">
                                                ...
                                                <div class="ribbon ribbon-top-left text-danger"><span class="bg-danger">10% Desconto</span></div>
                                                    <a href="#"></a>
                                                    <img src="../../assets//images/brand/SUA BOLSA ONLINE - LOGO PRIMARIA.png" alt="img" class="cover-image">
                                                </div>
                                                <div class="item-card9-icons">
                                                    <a href="#" class="item-card9-icons1 wishlist"> <i class="fa fa fa-heart-o"></i></a>
                                                </div>
                                                ...
                                                <div class="card-body ">
                                                    <div class="item-card2">
                                                        <div class="item-card2-desc">
                                                            ...
                                                            <div class="arrow-ribbon bg-primary">Educação</div>
                            <br>
                                                            <a href="classified.html" class="text-dark mt-2"><h4 class="font-weight-semibold mt-1">Sua Bolsa</h4></a>
                                                            <p class="mb-0 leading-tight">...</p>
                                                        </div>
                                                    </div>
                                                </div>
...
<!-- 											<div class="card overflow-hidden">
                                        ...
                                        <div class="card border-0 mb-0">
                                                <div class="card-body ">
                                                    <div class="item-card2">
                                                        <div class="item-card2-desc">
                                                            <a href="classified.html" class="">Vehicles</a>
