...
<html lang="zxx" dir="ltr">
	<head>
		...
		<!-- RTL Css -->
		<link href="<?php echo BASE_URL;?>assets/blog/css/rtl.css" rel="stylesheet" />
		...
		<!-- Cookie css 
		<link href="<?php echo BASE_URL;?>assets/blog/plugins/cookie/cookie.css" rel="stylesheet"> -->

		<!-- Owl Theme css-->
		<link href="<?php echo BASE_URL;?>assets/blog/plugins/owl-carousel/owl.carousel.css" rel="stylesheet" />

		<!-- video css-->
		<link href="<?php echo BASE_URL;?>assets/blog/plugins/video/insideElementDemo.css" rel="stylesheet" />
	...
	<body>
		...
		<div class="header-main">
					...
					<div class="row">
						<div class="col-xl-8 col-lg-8 col-sm-4 col-7">
							<div class="top-bar-left d-flex">
								<div class="clearfix">
									<ul class="socials">
										<li>
											<a class="social-icon text-dark" href="https://www.facebook.com/BSB-CLUB-112437210556987/"><i class="fa fa-facebook" target="_blank"></i></a>
										</li>
										<li>
											<a class="social-icon text-dark" href="https://www.instagram.com/bsbcluboficial/?igshid=xkbpe8556dea"><i class="fa fa-instagram" target="_blank"></i></a>
										</li>
									</ul>
								</div>
						...
						<div class="col-xl-4 col-lg-4 col-sm-8 col-5">
							<div class="top-bar-right">
								<ul class="custom">
									<!-- <li>
										<a href="#" class="text-dark"><i class="fa fa-user mr-1"></i> <span>Cadastre-se</span></a>
									</li>
									<li>
										<a href="#" class="text-dark"><i class="fa fa-sign-in mr-1"></i> <span>Entrar</span></a>
									</li>
									<li class="dropdown">
										...
										<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
											...
											<a href="#" class="dropdown-item" >
												<i class="dropdown-icon  icon icon-settings"></i> Configurações
											</a>
											<a class="dropdown-item" href="#">
			...
			<div class="horizontal-header clearfix ">
				<div class="container">
					...
					<span class="smllogo"><img src="<?php echo BASE_URL;?>assets/blog/images/brand/logo.png" width="120" style="margin-top: -10px;" alt=""/></span>
			...
			<div class="horizontal-main bg-dark-transparent clearfix" >
				<div class="horizontal-mainwrapper container clearfix">
					<div class="desktoplogo" style="height: 110px !important; width:auto;">
						<a href="<?php echo BASE_URL;?>"><img src="<?php echo BASE_URL;?>assets/blog/images/brand/logo-branca.png" style="height: 120px !important; width:auto; margin-top: -18px;" alt=""></a>
					</div>
					<div class="desktoplogo-1" >
						<a href="<?php echo BASE_URL;?>"><img src="<?php echo BASE_URL;?>assets/blog/images/brand/Artboard-22.png" style="height: 100px !important; width:auto; margin-top: -18px;" alt=""></a>
					</div>
					<!--Nav-->
					<nav class="horizontalMenu clearfix d-md-flex">
					<ul class="horizontalMenu-list" style="margin-top: 15px;">
							<li aria-haspopup="true"><a href="<?php echo BASE_URL."";?>" >Inicio </a>
							...
							<li aria-haspopup="true"><a href="<?php echo BASE_URL."pages/contact";?>" > Contato <span class="wsarrow"></span></a></li>
		...
		<div id="main">
			...
			" data-vidbg-bg="mp4: <?php echo BASE_URL;?>assets/blog/images/banners/slider-007.png, webm: ..assets/blog/images/banners/slider-007.png, poster: <?php echo BASE_URL;?>assets/blog/images/banners/slider-007.png" data-vidbg-options="loop: true, muted: true, overlay: false" style="background: none !important;">
				<div class="header-text text mb-0">
					<div class="container">
						<div class="text-center text-white mb-6">
							<a href="" class="typewrite" data-period="2000" data-type="[ &quot;BSB CLUB&quot; ]"><span class="wrap">BSBCLUB</span></a>
							<p>Um cartão para tudo, um cartão para Todos.</p>
						</div>
									...
									<div class="search-background bg-transparent">
										<div class="form row no-gutters ">
											<div class="form-group  col-xl-4 col-lg-3 col-md-12 mb-0 bg-white ">
												<input type="text" class="form-control input-lg br-tr-md-0 br-br-md-0" id="text4" placeholder="Palavra Chave" name="keyword">
											</div>
...
<!--Footer Section-->
		...
		<!-- video -->
		<script src="<?php echo BASE_URL;?>assets/blog/plugins/video/jquery.vide.js"></script>
