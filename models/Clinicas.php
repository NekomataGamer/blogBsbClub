...
class Clinicas extends Model{
    ...
    public function addConsulta($proc, $val_coust, $val_sell, $id){
        $sql = "INSERT INTO consultas SET id_clinica = :id_clinica, procedimento = :procedimento, val_coust = :val_coust, val_sell = :val_sell";
        $sql = $this->db->prepare($sql);
    ...
    public function editConsulta($proc, $val_coust, $val_sell, $id){
        $sql = "UPDATE consultas SET procedimento = :procedimento, val_coust = :val_coust, val_sell = :val_sell WHERE id_clinica = :id_clinica";
        $sql = $this->db->prepare($sql);
        $sql->bindValue(':procedimento', $proc);
        $sql->bindValue(':val_coust', $val_coust);
        $sql->bindValue(':val_sell', $val_sell);
